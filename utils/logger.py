...
class self_handler(logging.Handler):
    def __init__(self, name: str) -> None:
        ...
        self.name = name
        self.connect = CONNECTER.get_ck()
        self.connect.command(f"CREATE DATABASE IF NOT EXISTS logger")
        self.connect.command(f"USE logger")
...
def make_logger(logger_name: str, table_name: str) -> logging.Logger:
    ...
    mongoio = self_handler(table_name)
